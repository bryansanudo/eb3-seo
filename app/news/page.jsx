  ...
  const rss = [
    {
      ...
      title: "Tools Outage",
      content_html:
        "USCIS will conduct system maintenance to the Contact Relationship Interface System (CRIS) on Wednesday, Jan. 10, 2024 at 11:50 p.m. through Thursday, Jan. 11, 2024 at 2:00 a.m. Eastern.",
      summary:
        "USCIS will conduct system maintenance to the Contact Relationship Interface System (CRIS) on Wednesday, Jan. 10, 2024 at 11:50 p.m. through Thursday, Jan. 11, 2024 at 2:00 a.m. Eastern.",
      date_published: "2024-01-08T15:41:25.000Z",
      author: {
        name: "USCIS",
      },
    },
    {
      guid: "0df55e82-0ff4-4eb3-9f5c-0b6e178f8f1b",
      url: "https://www.uscis.gov/newsroom/alerts/uscis-issues-policy-guidance-on-ability-to-pay-requirement-when-adjustment-of-status-applicants",
      title:
      ...
      summary:
        "U.S. Citizenship and Immigration Services today issued policy guidance on how we analyze an employer’s ability to pay the proffered wage for immigrant petitions in certain first, second, and third preference employment-based immigrant visa classifications, including instances when the sponsored worker is changing employers.",
      date_published: "2024-01-05T14:29:41.000Z",
      author: {
        name: "USCIS",
      },
    },
    {
      guid: "88e169f0-78b0-44bc-9ed6-1ce517ea9bee",
      url: "https://www.uscis.gov/newsroom/alerts/uscis-announces-inflation-adjustment-to-premium-processing-fees",
      title: "USCIS Announces Inflation Adjustment to Premium Processing Fees",
      content_html:
      ...
      summary:
        "U.S. Citizenship and Immigration Services today announced a final rule that will increase the filing fee for Form I-907, Request for Premium Processing, to adjust for inflation.",
      date_published: "2023-12-27T14:29:42.000Z",
      author: {
        name: "USCIS",
      },
    },
    {
      guid: "85d7bdab-d343-49dd-ad0d-3027bc84dd8e",
      url: "https://www.uscis.gov/newsroom/alerts/uscis-updates-policy-guidance-for-international-students",
      title: "USCIS Updates Policy Guidance for International Students",
      content_html:
      ...
      summary:
        "U.S. Citizenship and Immigration Services (USCIS) is issuing policy guidance regarding the F and M student nonimmigrant classifications, including the agency’s role in adjudicating applications for employment authorization, change of status, extension of stay, and reinstatement of status for these students and their dependents in the United States.",
      date_published: "2023-12-20T14:36:01.000Z",
      author: {
        name: "USCIS",
      },
    },
    ...
    <div className="max-w-6xl pt-40  mx-auto px-6">
      ...
      <div className="mb-4">
        <input
          ...
          className="input input-primary w-full max-w-xs input-sm"
        />
      </div>
        ...
        <div key={guid} className="flex  flex-col border-b pt-10 mb-4  w-full">
          <p className={`  mb-3`}>
            <a target="_blank" href={url}>
              <span
                className={`${styles.sectionText} font-bold hover:border-b hover:border-primary hover:text-primary`}
              >
                {title}
              </span>
            </a>
          </p>
          <p className={`  w-full   tracking-wider  mb-3`}>{content_html}</p>
        </div>
      ))}
